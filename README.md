# sotagents.com API client

This is a client for [PapersWithCode](https://sotagents.com/api/v1/docs/)
read/write API.
...
[ReadTheDocs](https://sotagents-client.readthedocs.io/en/latest/) website.

It is published to the
[Python Package Index](https://pypi.org/project/sotagents-client/) and
can be installed by simply calling `pip install sotagents-client`.
...
For full docs please see our [ReadTheDocs](https://sotagents-client.readthedocs.io/en/latest/) page.
...
To use the API in the write mode you'll need to first [obtain an API token](https://sotagents.com/accounts/generate_api_token).
...
new task on the [Task addition page](https://sotagents.com/add/task). 
...
You can then access it by going to `https://sotagents.com/sota/<your_leaderboard_id>` or find it using 
the site search.  
...
For in-depth API docs please refer to our [ReadTheDocs](https://sotagents-client.readthedocs.io/en/latest/) page.
...
If you need any help contact us on hello@sotagents.com. 
